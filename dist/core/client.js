...
export class DiscordBot {
    ...
    constructor() {
        ...
        this.registerCommand(ChannelsCommand);
        this.registerCommand(ModelCommand);
        this.registerCommand(ImageCommand);
        this.registerCommand(ModerationCommand);
        ...
        this.client.on("interactionCreate", async (interaction) => {
            ...
            try {
                ...
                if (!interaction.replied)
                    await interaction.reply({ ephemeral: true, content: "Command failed." });
            }
        });
